...
const Forms = () => {
  ...
  const postData = (e) => {
    ...
    e.preventDefault();
    axios.post('http://127.0.0.1:8000/Chartdatatable/', {
      name,
      fathername,
      dob,
      statecode,
        ...
        <Card>
          ...
          <CardBody>
            ...
            <FormGroup>
              ...
              <Button type="submit" style={{backgroundColor: "blue",color:"white"}} onClick={postData}>Submit</Button>
              <Button component={Link} to="/forms2" className="m-2" style={{backgroundColor: "blue",color:"white"}}>Next</Button>
            </Form>
          </CardBody>
        </Card>
      </Col>
